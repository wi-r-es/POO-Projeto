...
public:
    /*******************************************************************************************************************************************************************
     * @brief Constructor for Casino with specified position parameters.
     *
     * This constructor initializes a `Casino` instance with a given name and specific position parameters (`posX`, `posY`). It sets up the casino's name and
     * initializes a new `Clock` instance to manage time-related actions within the casino. The constructor also initializes the maximum number of players and
     * the jackpot radius with default values.
     *
     * @param name The name of the casino.
     * @param posX The x-coordinate of the casino's position.
     * @param posY The y-coordinate of the casino's position.
     *
    ...
    /*******************************************************************************************************************************************************************
     * @brief Default Constructor for Casino.
     *
     * This default constructor initializes a `Casino` instance with a given name and default position values (0, 0). It sets up the casino's name and initializes
     * a new `Clock` instance, along with default values for maximum players and jackpot radius. This constructor is used when specific position parameters are
     * not required for the casino.
     *
     * @param name The name of the casino.
     *
     * @exception None. This constructor does not throw exceptions.
     ...
     *
     * These functions add either a `User` or a `Machine` to the casino. For `User`, it sets an initial money value and adds the user to the user list. For
     * `Machine`, it checks the availability of the machine's position and adds the machine to the casino if the position is available.
     *
     * @param usr A pointer to the `User` object to be added.
     * @param m A pointer to the `Machine` object to be added.
     *
     ...
     *
     * This function sets the state of a machine with a specified ID to `BROKEN`. If the machine ID is found, it is also added to the list of broken machines. If
     * the ID is not found, an appropriate message is displayed.
     *
     ...
     * such as maintenance checks, probability adjustments, or gameplay simulations.
     *
